      ...
      <section class="cart-page">
        <div class="container">
          <div class="cart-empty">
            ...
            <p class="cart-empty__text">Looks like you haven't added any sacred items yet.</p>
      ...
      <div class="container">
        ...
        <div class="cart-page__inner">
            ...
            .map(
              ...
              <div class="cart-item" data-product-id="${item.id}">
                ...
                <div class="cart-item__info">
                  ...
                  <div class="cart-item__remove" data-remove-id="${item.id}">✕ Remove</div>
                </div>
              </div>
            `
            )
          ...
          <div class="cart-summary">
            ...
            ${shipping > 0 ? `<div style="font-size:var(--text-xs);color:var(--color-text-muted);margin-top:var(--space-1);">Free shipping on orders above ₹999</div>` : ''}
            ...
            <p class="cart-summary__note">
              ...
              Payment via UPI will be arranged after confirmation.
            </p>
          </div>
        </div>
      </div>
